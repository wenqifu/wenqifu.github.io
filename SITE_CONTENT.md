...
My research focuses on **efficient training of large models** — my recent work [GradES](https://arxiv.org/abs/2509.01842) achieves 1.57–7.22× faster transformer fine-tuning by selectively freezing components at convergence. I also work on **federated learning** (gradient stable rank adaptive compression), **sim-to-real robotics** (OceanEnv marine simulation), and **HCI evaluation** of AI systems. I have a strong mathematical foundation in measure-theoretic probability, stochastic processes, and parameter estimation.
...
- **Authors:** Eugene Pinsky, Qifu Wen
...
- **Authors:** Qifu Wen, Xinyu Zeng, Ziyi Zhou, Shuwei Liu, Mahdi Hosseinzadeh, Reza Rawassizadeh
- **Year:** 2025
- **Status:** preprint
- **ArXiv:** 2509.01842
- **Note:** Targeting NeurIPS 2026
...
- **Authors:** Kasra Khedri, Qifu Wen, Mahdi Hosseinzadeh, Reza Rawassizadeh
...
2025-06-01 | Paper "[From Clicks to Conversations](https://doi.org/10.1080/10447318.2025.2561760)" published in _International Journal of Human-Computer Interaction_.
...
Visiting Researcher | Jan 2025 - present
- Lead author on GradES (1.57–7.22× faster transformer fine-tuning); targeting NeurIPS 2026.
- Co-first author on OceanEnv marine robotics simulation; submitted to IROS 2026.
- Developing Fed-GSR federated learning framework; targeting NeurIPS 2026.
...
Conference Reviewing: ICML (2025, 2026), MLSys (2026)

### Awards

**AI & Computer Vision Lab Student Research Grant** | 2024 | Boston University
